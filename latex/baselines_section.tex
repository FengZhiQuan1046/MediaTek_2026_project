...
This section consolidates published Amazon results that are useful for
positioning the proposed pipeline. The collection is protocol-aware. An Amazon
category name is not a complete dataset specification: Amazon Reviews 2018 and
Amazon Reviews 2023 contain different users, items, metadata, and time ranges,
and papers apply different $k$-core filters and splits. Candidate construction
is equally important. A score obtained by ranking one positive against sampled
negatives is generally much higher than a score obtained by ranking the
complete catalog. Consequently, the tables below are literature references,
not a leaderboard across table boundaries.
