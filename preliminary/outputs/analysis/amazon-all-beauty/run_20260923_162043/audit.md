...
- Every cosine is normalized with the mean and standard deviation of random distinct training-item pairs from its own subset. Normalizer values are stored in diagnostics.json.
