...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs_mamba_rl}"
...
PREFERENCE_COUNT="${PREFERENCE_COUNT:-64}"
...
PREFERENCE_TINY_MAMBA_DIM="${PREFERENCE_TINY_MAMBA_DIM:-32}"
...
HARD_NEGATIVE_POOL_MULTIPLIER="${HARD_NEGATIVE_POOL_MULTIPLIER:-4}"
...
ARGS=(
  ...
  --preference-tiny-mamba-dim "$PREFERENCE_TINY_MAMBA_DIM"
